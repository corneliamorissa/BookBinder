...
final class Version20230526084222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE libraries (id INT AUTO_INCREMENT NOT NULL PRIMARY KEY , name VARCHAR(45) not null , street VARCHAR(45) not null , housenumber VARCHAR(45) not null , postcode INT not null )');
